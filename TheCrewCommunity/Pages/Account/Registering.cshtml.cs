...
public class Registering : PageModel
{
    ...
    /*
    public async Task<IActionResult> OnGetAsyncold()
    {
        ...
        if (discordUser is not null)
        {
            ...
            {
                var roles = discordMember.Roles;
                bool isMod = roles.Any(role => role is { Permissions: Permissions.ModerateMembers });
                applicationUser.IsModerator = isMod;
            }
        }
